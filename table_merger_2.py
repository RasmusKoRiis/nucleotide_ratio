...
melted_df = pd.melt(merged_df, id_vars=['base_position', 'sample_x', 'sample_y'], value_vars=['adenine_x', 'cytosine_x', 'guanine_x', 'thymine_x', 'adenine_y', 'cytosine_y', 'guanine_y', 'thymine_y'], var_name='value_vars', value_name='nucleotide')
...
melted_df.drop(columns=['sample_x', 'sample_y'], inplace=True)
